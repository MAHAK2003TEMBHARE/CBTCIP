...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno)
    {
     ...
     JLabel number=new JLabel("XXXX-XXXX-XXXX-4101");
     number.setFont(new Font("Raleway",Font.BOLD,25));
     number.setBounds(330,300,300,30);
     add(number);
     
     JLabel carddetail=new JLabel("This is your 16 digits Card Number");
     ...
     JLabel pindetail=new JLabel("This is your 4 digits Pin Number");
     pindetail.setFont(new Font("Raleway",Font.BOLD,12));
     pindetail.setBounds(100,400,300,22);
     add(pindetail);
